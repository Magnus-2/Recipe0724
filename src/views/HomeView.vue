...
<body data-spy="scroll" data-target=".navbar" data-offset="40" id="home" class="dark-theme">
    ...
    <header class="header">
        ...
        <div class="header-content">
            ...
            <iframe width="560" height="315" src="https://www.youtube.com/embed/sv3TXMSv6Lw" frameborder="0" allowfullscreen></iframe>
    ...
    <div class="container page-container">
        ...
        <div class="row mb-4">
            <div class="col-md-4">
                <a href="recipes" class="overlay-img">
    ...
    <div class="contact-section">
        ...
        <div class="container">
            ...
            <!-- footer -->
            <footer class="footer">
                <p class="infos">&copy;, Made with <i class="ti-heart text-danger"></i> by Celina, Magnus, Till,Robin and Kevin</p>       
                <span>|</span>  
                <div class="links">
                    <a href="#">About</a>
                    <a href="#">Recipe</a>
