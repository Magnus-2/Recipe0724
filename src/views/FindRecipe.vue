<template>
  <div class="FindRecipes">
    ...
    <br>
    <br>
    <h2 style="color: black;">Use your leftovers in the best way</h2>
...
<br>
      ...
      <div class="container">
  <div class="row">
    <div class="col-sm-6 col-md-6 col-lg-6" v-for="(recipe, key) in recipes.slice(0, 2)" :key="key">
      <p class="recipename">{{ recipe.Recipe_Name }}</p>
      <img v-bind:src="`../src/assets/imgs/${recipe.image}`" width="400" height="300" alt="pic">
      <div>
      <router-link :to="{ path: 'info', name: 'Info', params: { recipe: recipe.Recipe_Name } }"><br>
  ...
  <div class="row">
    <div class="col-sm-6 col-md-6 col-lg-6" v-for="(recipe, key) in recipes.slice(2, 4)" :key="key">
      <p class="recipename">{{ recipe.Recipe_Name }}</p>
      <img v-bind:src="`../src/assets/imgs/${recipe.image}`" width="400" height="300" alt="pic">
      <div>
      <router-link :to="{ path: 'info', name: 'Info', params: { recipe: recipe.Recipe_Name } }"><br>
...
.theme-selector .spinner {
  ...
  width: 20px;
  height: 20px;
  background-image: url('https://example.com/spinner.png');
  background-repeat: no-repeat;
